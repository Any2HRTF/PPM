...
parsePool = [ppm.modify.pc, ppm.modify.mesh, ppm.modify.remesh, ppm.modify.image,...
    ppm.modify.set_cam, ppm.modify.depth, ppm.modify.shade_smooth];
...
switch ppm.ini.verbose_level
    ...
    case 0
        args = [ppm.ini.path.blender_exe, ' ', ppm.ini.blender_file...
            ' -b -P ' fullfile(ppm.ini.path.python,'set_values_and_export_mesh_v1_5_0.py'),' -- ', ...
            ppm.ini.path.result, ' ',...
            parsedStrings{1}, ' ',...
            parsedStrings{2}, ' ',...
            parsedStrings{3}, ' ',...
            ...
            parsedStrings{7},' ',...
            num2str(ppm.modify.coordinate_system),...
            ' -a > nul 2>&1'
            ];
