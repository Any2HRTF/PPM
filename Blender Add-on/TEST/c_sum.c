...
DLL00_EXPORT_API ELEMENT_TYPE* matrixFunc(const ELEMENT_TYPE *pMatP, size_t rows_p, size_t cols_p, const ELEMENT_TYPE *pMatQ, size_t rows_q, size_t cols_q);
...
{
    //get all points
    ELEMENT_TYPE * pRet = (double *)malloc(sizeof(double) * (rows_p + 0));
